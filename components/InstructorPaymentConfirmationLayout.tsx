...
>(({ paymentData }, ref) => {
  return (
    ...
    >
      ...
      */}
      <div style={{ textAlign: 'center', marginBottom: '4mm', paddingBottom: '4mm', borderBottom: '1px solid #000' }}>
      ...
      */}
      <div style={{ marginBottom: '2.5mm', display: 'grid', gridTemplateColumns: '1fr', gap: '1.5mm' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '50mm 1fr', gap: '5px', alignItems: 'flex-start' }}>
          ...
          <div style={{ paddingBottom: '0px', minHeight: '20px', fontSize: '13pt', lineHeight: '1.15' }}>: {paymentData.eventName}</div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '50mm 1fr', gap: '5px', alignItems: 'flex-start' }}>
          <span style={{ fontWeight: 'bold', fontSize: '13pt' }}>□ 강의일시</span>
          <div style={{ paddingBottom: '0px', minHeight: '20px', fontSize: '13pt', lineHeight: '1.15' }}>: {formatEventDateTime(paymentData.eventDate, paymentData.eventTime)}</div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '50mm 1fr', gap: '5px', alignItems: 'flex-start' }}>
          <span style={{ fontWeight: 'bold', fontSize: '13pt' }}>□ 장소</span>
          <div style={{ paddingBottom: '0px', minHeight: '20px', fontSize: '13pt', lineHeight: '1.15' }}>: {paymentData.location || ''}</div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '50mm 1fr', gap: '5px', alignItems: 'flex-start' }}>
          <span style={{ fontWeight: 'bold', fontSize: '13pt' }}>□ 강의주제</span>
          <div style={{ paddingBottom: '0px', minHeight: '20px', fontSize: '13pt', lineHeight: '1.15' }}>: {paymentData.topic}</div>
        </div>
      </div>
      ...
      */}
      <div style={{ marginBottom: '2.5mm', fontSize: '13pt' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '50mm 1fr', gap: '5px', alignItems: 'flex-start', marginBottom: '1mm' }}>
          ...
          <div style={{ paddingBottom: '0px', minHeight: '20px', fontSize: '13pt', lineHeight: '1.15' }}>: {paymentData.instructorIdNumber}</div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '50mm 1fr', gap: '5px', alignItems: 'flex-start', marginBottom: '1mm' }}>
          <span style={{ fontSize: '13pt' }}>  - 연락처</span>
          <div style={{ paddingBottom: '0px', minHeight: '20px', fontSize: '13pt', lineHeight: '1.15' }}>: {paymentData.instructorPhone}</div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '50mm 1fr', gap: '5px', alignItems: 'flex-start', marginBottom: '1mm' }}>
          <span style={{ fontSize: '13pt' }}>  - 지급금액</span>
          <div style={{ paddingBottom: '0px', minHeight: '20px', fontSize: '13pt', lineHeight: '1.15' }}>: {paymentData.instructorFee.toLocaleString()}원(원천징수 후 실지급 {paymentData.netAmount.toLocaleString()}원)</div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '50mm 1fr', gap: '5px', alignItems: 'flex-start' }}>
          <span style={{ fontSize: '13pt' }}>  - 입금계좌</span>
          <div style={{ paddingBottom: '0px', minHeight: '20px', fontSize: '13pt', lineHeight: '1.15' }}>: {paymentData.instructorBankName} {paymentData.instructorAccountNumber}</div>
        </div>
      </div>
      ...
      */}
      <div style={{
        ...
        padding: '2mm', // 1. 전체 안쪽 여백
        marginBottom: '2mm', // 2. 하단 바깥 여백
        fontSize: '9pt',
        ...
        <h3 style={{
          fontWeight: 'bold',
          lineHeight: '1.2',
          fontSize: '10pt', // 5. 제목 폰트
          margin: '0',
          textAlign: 'center', // 6. 이미지와 같이 가운데 정렬
          marginBottom: '2mm' // 7. 제목과 본문 사이 간격
        }}>
        ...
        <div style={{
          fontSize: '9pt',
          marginBottom: '2mm', // 8. 본문과 박스 사이 간격
          lineHeight: '1.25' // 9. 줄 간격
        }}>
      ...
      <div style={{
        ...
        <div style={{
          border: '1px solid #000',
          padding: '1.5mm', // 13. 박스 내부 여백
          display: 'flex',
          flexDirection: 'column'
        }}>
          <p style={{ fontWeight: 'bold', fontSize: '9pt', margin: '0 0 1mm 0' }}> {/* 14. 소제목과 내용 사이 간격 */}
            [개인정보 처리]
          </p>
